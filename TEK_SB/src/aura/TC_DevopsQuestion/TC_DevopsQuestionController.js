({
    ...
    nextQuestion : function(component, event, helper) {
     ...
     /*   var cnt = component.get('v.countQuestion');
        cnt = cnt + 1;
        
        component.set( 'v.countQuestion',cnt);*/
        //3rd end
        component.set( 'v.showFeedBack',false);
        component.set( 'v.showQuestion',true);
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {                   
               ...
               //  component.set('v.countQuestion',result.questioncount);
    ...
    closeFeedback : function(component, event, helper) { 
       ...
       var auto = component.get("v.autoValue"); 
        ...
        action.setParams({"responseQuestion":ques,"responseAnswer":ans,"responseAutoNum":auto,"recordId":surId});
        action.setCallback(this, function(response) {
            var state = response.getState();
